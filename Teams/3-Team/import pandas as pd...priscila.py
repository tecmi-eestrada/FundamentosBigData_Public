...
class Restaurante:
    def _init_(self, nombre, tipo_de_restaurante, fundacion, mascota):
...
class Productos:
    def _init_(self, nombre, descripcion, precio:float):
        self.nombre = nombre
...
class Platillo(Productos):
    def _init_(self, nombre, descripcion, precio):
        super()._init_(nombre, descripcion, precio)
...
class Combo(Productos):
    def _init_(self, nombre, platillo, bebida, extra, descripcion, precio=0):
        super()._init_(nombre, descripcion, precio)
...
flautas = Platillo("flautas", "Platillo rico", 45.50)
...
aguas = Bebida("boing de fresa","RICOS", 25)
#Lista de bebidas
...
file_write_write = open ("C:/Users/prisc/Downloads/a.txt")
...
combo_patrio = Combo("combo patrio", flautas.nombre, agua.nombre, papas_enchiladas.nombre, "Combo rico", handler.calc_precio_combo(flautas, agua, papas_enchiladas))
