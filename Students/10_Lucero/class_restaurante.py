...
nombre = Restaurante("TAQUITO FELZ")
tipo_comida = Restaurante("Antojitos mexicanos")
fundacion = Restaurante("1ero de Enero 1989")
mascota = Restaurante("Taquito")


#Ejemplo de uso
handler = Handler()
#Creacion de objetos platillos
enchiladas = Platillo("ENCHILADAS ROJAS ESTILO ZACATECAS", "4 Tacos de lomo de cerdo deshebrado, con una salsa de chile de árbol y chile guajilo","Precio: ", 120)
...
with open (enchiladas, "r") as archivo:
    archivo.write ("ENCHILADAS ROJAS ESTILO ZACATECAS", "4 Tacos de lomo de cerdo deshebrado, con una salsa de chile de árbol y chile guajilo","Precio: ", 120)



# #Lista de platillos
# platillos = [enchiladas, flautas, entomatadas, enchiladas, sopes]
